...
function handleActionButtons(addToCartButtonDOM, product) {
    ...
    cartItemsDOM.forEach(cartItemDOM => {
        ...
        if (cartItemDOM.querySelector('.cart__item__name').innerText === product.name) {
            ...
            cartItemDOM.querySelector('[data-action="INCREASE_ITEM"]').addEventListener('click', () => increaseItem(cartItemDOM, product));
            cartItemDOM.querySelector('[data-action="DECREASE_ITEM"]').addEventListener('click', () => decreaseItem (cartItemDOM, product, addToCartButtonDOM));
            cartItemDOM.querySelector('[data-action="REMOVE_ITEM"]').addEventListener('click', () => removeItem (cartItemDOM, product, addToCartButtonDOM));
        }
    });
}
